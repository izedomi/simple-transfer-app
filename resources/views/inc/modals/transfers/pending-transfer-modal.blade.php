<div class="modal fade" id="pending-{{$transfer['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
             ...
             <div class="col-md-7 justify-content-end">
               <p>
                 ...
                 {{$transfer['status']}}
                   ...
                   <i class="fa fa-times fa-fw text-primary"></i>
